...
INSERT INTO "new_Job" ("courierAddress", "createdAt", "creatorAddress", "description", "dropoffAddress", "eta", "id", "isDeleted", "metadataHash", "packageType", "pickupAddress", "reward", "status", "updatedAt") SELECT "courierAddress", "createdAt", "creatorAddress", "description", "dropoffAddress", "eta", "id", "isDeleted", "metadataHash", "packageType", "pickupAddress", "reward", "status", "updatedAt" FROM "Job";
DROP TABLE "Job";
